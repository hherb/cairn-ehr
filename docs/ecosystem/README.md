...
| [0003](0003-reference-data-sourcing-medicines-and-terminologies.md) | External reference-data sourcing | WHO INN · RxNorm · DailyMed/openFDA · TGA ARTG · PBS · ICD-10/11 · ICPC · Mondo/ORDO | **Evaluation.** Medicines: INN-anchored substance UUID + public-domain/CC-BY government feeds bundle freely; ATC/DDD, DrugBank, AMH/eTG, SNOMED-AMT excluded; DDI gap real. Disease/injury: ICD-11 (CC BY-ND, verbatim codes OK) the best stable-ID fit incl. offline container; ICPC-3 conditional on its CC variant; Mondo/ORDO (CC BY 4.0) clean substrate; SNOMED/ICD-10-AM/ICPC-2-PLUS excluded. Human-verify items remain. |
