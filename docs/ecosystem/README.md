...
| [0003](0003-reference-data-sourcing-medicines-and-terminologies.md) | External reference-data sourcing | WHO INN · RxNorm · DailyMed/openFDA · TGA ARTG · PBS · ICD/ICPC (terminologies) | **In progress.** Medicines tier resolved: INN-anchored substance UUID + public-domain/CC-BY government feeds bundle freely; ATC/DDD, DrugBank, AMH/eTG, SNOMED-AMT excluded by licence; DDI gap real. Disease/injury terminology thread open. |
